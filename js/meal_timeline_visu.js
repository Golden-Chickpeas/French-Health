...
// import data and create chart
    ...
    //data/csv/duree_repas_mean/duree_repas_mean_of_tyrep_Dejeuner_of_nojour_1_of_sexe_2.csv
    //+loaded_filters[0]+loaded_filters[1]+".csv";
    var data = [];
    var counter = 0;
    [1,2,3,4,5,6,7].forEach(function (numjour) {
        ...
        ['Petit-dejeuner','Dejeuner', 'Diner'].forEach(function(typerep){
            // console.log(basepath+"_of_tyrep_"+typerep+"_of_nojour_"+numjour+".csv");
            d3.text(basepath+"_of_tyrep_"+typerep+"_of_nojour_"+numjour+".csv",
                function (error, raw) {
                    ...
                    if (d['mean']){
                        ...
                        // console.log(daily_data[typerep])
                    }
                    counter=counter+1;
                    if (counter == 21)
    ...
    function continueExecution(data)
    {
        ...
        // console.log("xscaledomain");console.log(xScale)
        yScale.domain([
            0,
